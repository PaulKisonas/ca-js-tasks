let nouns = ['apple', 'sister', 'hammer', 'sun', 'table', 'sky', 'lake', 'friends', 'house', 'Lamborghini', 'expensive', 'car'];
// indeksai:    0       1         2        3       4        5       6    
let helpers = ['in', 'with', 'on', 'my', 'is', 'a', 'the', ' ', 'not'];
...
let sentence5 = helpers[3] + helpers[7] + nouns[1] + helpers[7] + helpers[4] + helpers[7] + helpers[0] + helpers[7] + nouns[7] + helpers[7] + nouns[8]
console.log(sentence5)
let sentence6 = nouns[9] + helpers[7] + helpers[4]  + helpers[7] + nouns[10] + helpers[7] + nouns[11]
console.log(sentence6)
let sentence7 = helpers[3] + helpers[7] + nouns[1] + helpers[7] + nouns[11] + helpers[7] + helpers[4] + helpers[7] + helpers[8] + helpers[7] + nouns[10]
